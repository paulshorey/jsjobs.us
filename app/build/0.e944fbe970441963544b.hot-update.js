...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_keys__ = __webpack_require__("babel-runtime/core-js/object/keys");
...
var Results = function (_Component) {
  ...
  */
		...
		value: function render() {
			...
			var results_length = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_keys___default()(this.props.items).length - items_array.length;
			// make Array
			var Items = [];
			if (items_array) {
				var i = 0;
			...
			return __WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13__Query__["a" /* default */], { area_key: this.props.area_key, expanded: this.state.searchQueryExpanded, placeholder: (this.props.filters.length ? "Filter" : "Search") + " " + results_length + " " + (this.props.filters.length ? "results" : "jobs") + "...", __source: {
							fileName: _jsxFileName,
							lineNumber: 173
						}
					}),
...
//# sourceMappingURL=0.e944fbe970441963544b.hot-update.js.map