...
var areas = function areas() {
	...
	switch (action.type) {
		...
		case "area_item_edit":
			console.log("before", state[action.area_key].items[action.item._id]);
			console.log("after", __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()({}, action.item));
			state[action.area_key].items[action.item._id] = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()({}, action.item);
			return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()({}, state);
		case "area_items_set":
...
//# sourceMappingURL=0.ab7d1752bf362206670f.hot-update.js.map