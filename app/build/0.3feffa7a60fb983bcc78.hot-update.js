...
var search_areas = function search_areas() {
	...
	switch (action.type) {
		case "area_item_my":
			...
			state[action.area_key].items[action.item._id];
		...
		case "area_items_add":
			...
			console.error("delete: ", state[action.area_key].items[i_index]);
...
//# sourceMappingURL=0.3feffa7a60fb983bcc78.hot-update.js.map