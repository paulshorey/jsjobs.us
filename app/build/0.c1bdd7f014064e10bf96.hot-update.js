...
var Results = function (_Component) {
	...
	function Results() {
		...
		return _ret = (_temp = (_this2 = __WEBPACK_IMPORTED_MODULE_5_babel_runtime_helpers_possibleConstructorReturn___default()(this, (_ref = Results.__proto__ || __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_get_prototype_of___default()(Results)).call.apply(_ref, [this].concat(args))), _this2), _this2.state = {}, _temp), __WEBPACK_IMPORTED_MODULE_5_babel_runtime_helpers_possibleConstructorReturn___default()(_this2, _ret);
	}
							...
							__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(
								...
								__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(
									"span",
									{
										...
										onClick: function onClick() {
											...
											_this3.props.dispatch(__WEBPACK_IMPORTED_MODULE_12__data_actions__["d" /* my_item_save */](__WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_assign___default()({}, item, { _status: "applied" }), _this3.props.area_key));
										},
										__source: {
											fileName: _jsxFileName,
											lineNumber: 135
								...
								__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(
									"span",
									{
										...
										onClick: function onClick() {
											// NOT immutable: immediately assigns to existing, rendered item - handle all immutability in Redux actions
											_this3.props.dispatch(__WEBPACK_IMPORTED_MODULE_12__data_actions__["d" /* my_item_save */](__WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_assign___default()({}, item, { _status: "intrigued" }), _this3.props.area_key));
										},
										__source: {
											fileName: _jsxFileName,
											lineNumber: 144
								...
								__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(
									"span",
									{
										...
										onClick: function onClick() {
											// NOT immutable: immediately assigns to existing, rendered item - handle all immutability in Redux actions
											_this3.props.dispatch(__WEBPACK_IMPORTED_MODULE_12__data_actions__["d" /* my_item_save */](__WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_assign___default()({}, item, { _status: "ignored" }), _this3.props.area_key));
										},
										__source: {
											fileName: _jsxFileName,
											lineNumber: 153
...
var mapStateToProps = function mapStateToProps(data, ownProps) {
	...
	var items_array = sort_items_object_to_array.bind(_this)(items_object, filters);
...
//# sourceMappingURL=0.c1bdd7f014064e10bf96.hot-update.js.map