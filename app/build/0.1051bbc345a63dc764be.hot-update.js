...
var mapStateToProps = function mapStateToProps(data, ownProps) {
	...
	console.log("process ownProps.items", __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_values___default()(ownProps.items).substring(0, 10));
	var items = sort_items_object_to_array(ownProps.items, filters);
	console.log("process items (array)", items.substring(0, 10));
	var newProps = {
		items: items,
...
//# sourceMappingURL=0.1051bbc345a63dc764be.hot-update.js.map