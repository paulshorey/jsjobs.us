...
var mapStateToProps = function mapStateToProps(data, ownProps) {
	...
	var newProps = {
		area: {
			...
			my_items_applied: data.my.applied.length,
			my_items_intrigued: data.my.intrigued.length,
			my_items_ignored: data.my.ignored.length,
...
//# sourceMappingURL=0.4686c039888de7b7fdee.hot-update.js.map