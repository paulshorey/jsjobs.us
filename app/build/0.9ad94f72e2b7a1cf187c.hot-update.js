...
var mapStateToProps = function mapStateToProps(data, ownProps) {
	...
	var newProps = {
		area: {
			...
			my_items_applied: data.my.items.find(function (item) {
				return item.status === "applied";
			}),
			my_items_intrigued: data.my.items.find(function (item) {
				return item.status === "intrigued";
			}),
			my_items_ignored: data.my.items.find(function (item) {
...
//# sourceMappingURL=0.9ad94f72e2b7a1cf187c.hot-update.js.map