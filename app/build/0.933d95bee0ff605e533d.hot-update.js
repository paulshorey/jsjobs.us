...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_typeof__ = __webpack_require__("babel-runtime/helpers/typeof");
...
var Results = function (_Component) {
	...
	function Results() {
		...
		return _ret = (_temp = (_this = __WEBPACK_IMPORTED_MODULE_6_babel_runtime_helpers_possibleConstructorReturn___default()(this, (_ref = Results.__proto__ || __WEBPACK_IMPORTED_MODULE_3_babel_runtime_core_js_object_get_prototype_of___default()(Results)).call.apply(_ref, [this].concat(args))), _this), _this.state = {}, _this.rateItems = function (newItems) {
			/*
		...
		value: function render() {
			...
			if (rated_items) {
				...
				var _loop = function _loop() {
					...
					if ((typeof item === "undefined" ? "undefined" : __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_typeof___default()(item)) !== "object") {
						return "break";
					}
					// item.rating
							...
							__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(
								...
								__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(
									"span",
									{
										...
										onClick: function onClick() {
											_this2.props.dispatch(__WEBPACK_IMPORTED_MODULE_12__data_actions__["c" /* area_item_add */](__WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_assign___default()(item, { _status: "applied" }), _this2.props.area_key));
										},
										__source: {
											fileName: _jsxFileName,
											lineNumber: 114
								...
								__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(
									"span",
									{
										className: "pill",
										onClick: function onClick() {
											_this2.props.dispatch(__WEBPACK_IMPORTED_MODULE_12__data_actions__["c" /* area_item_add */](__WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_assign___default()(item, { _status: "intrigued" }), _this2.props.area_key));
										},
										__source: {
											fileName: _jsxFileName,
											lineNumber: 122
								...
								__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(
									"span",
									{
										className: "pill",
										onClick: function onClick() {
											_this2.props.dispatch(__WEBPACK_IMPORTED_MODULE_12__data_actions__["c" /* area_item_add */](__WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_assign___default()(item, { _status: "ignored" }), _this2.props.area_key));
										},
										__source: {
											fileName: _jsxFileName,
											lineNumber: 130
			...
			return __WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13__Query__["a" /* default */], { area_key: this.props.area_key, expanded: this.state.searchQueryExpanded, placeholder: (this.props.area.filters.length ? "Filter" : "Search") + " " + rated_items.length + " " + (this.props.area.filters.length ? "results" : "jobs") + "...", __source: {
							fileName: _jsxFileName,
							lineNumber: 149
						}
					}),
...
var mapStateToProps = function mapStateToProps(data, ownProps) {
	console.log(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(data, null, " "));
	var area = data.areas[ownProps.area_key];
	var items = area.items.length ? area.items : [];
	var items_ids = [];
	items.map(function (item) {
		return items_ids.push(item._id); // make new array with only _id values
	});
	var newItems = ownProps.items.filter(function (item) {
		return items_ids.indexOf(item._id) === -1; // filter out items which were saved to redux
	});
	var newFilters = area.filters.length ? area.filters : [];
	var newProps = {
		area: {
			items: newItems,
			filters: newFilters
...
//# sourceMappingURL=0.933d95bee0ff605e533d.hot-update.js.map