...
var initialState = {
	us: { route: "/", key: "us", label: "Select region...", filters: [] },
	la: { route: "/in/la", key: "la", label: "in LA (Southern California)", filters: [] },
	nyc: { route: "/in/nyc", key: "nyc", label: "in NYC (New York City)", filters: [] },
	denver: { route: "/in/denver", key: "denver", label: "in Denver (Northern Colorado)", filters: [] }
};
var search_areas = function search_areas() {
	...
	switch (action.type) {
		...
		// 	let i_index = state[action.area_key].filters.findIndex(function(item) {
...
//# sourceMappingURL=0.4a89a64132d6901a6a9c.hot-update.js.map