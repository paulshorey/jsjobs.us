...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__styled_Results_js__ = __webpack_require__("./src/components/search/styled/Results.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_react_router__ = __webpack_require__("react-router");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__Query__ = __webpack_require__("./src/components/search/Query.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__Links__ = __webpack_require__("./src/components/search/Links.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__Filters__ = __webpack_require__("./src/components/search/Filters.js");
	...
	__WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_createClass___default()(Results, [{
		...
		value: function componentWillReceiveProps(props) {
			if (props.items && props.items.length !== this.props.items.length) {
				this.props.dispatch(__WEBPACK_IMPORTED_MODULE_10__data_actions__["d" /* area_items_set */](props.items, this.props.area_key));
			}
		}
		/*
  	view
		...
		value: function render() {
			...
			if (rated_items) {
				...
				var _loop = function _loop() {
					...
					var Rating = null;
					if (rating > 0) {
						Rating = __WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(
							"b",
							...
							__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement("span", { className: "icon-ui-thumbs-up", __source: {
									fileName: _jsxFileName,
									lineNumber: 82
								}
							}),
					...
					if (rating < 0) {
						Rating = __WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(
							...
							__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement("span", { className: "icon-ui-thumbs-down", __source: {
									fileName: _jsxFileName,
									lineNumber: 90
								}
							}),
						...
						__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(
							...
							__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(
								...
								__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(
									...
									__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement("span", { className: "icon-navigation", __source: {
											fileName: _jsxFileName,
											lineNumber: 108
										}
									}),
							...
							__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(
								...
								__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(
									"span",
									{
										...
										onClick: function onClick() {
											_this2.props.dispatch(__WEBPACK_IMPORTED_MODULE_10__data_actions__["c" /* area_item_edit */](__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()(item, { _status: "applied" }), _this2.props.area_key));
										},
										__source: {
											fileName: _jsxFileName,
											lineNumber: 117
									...
									__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement("span", { className: "icon-check", __source: {
											fileName: _jsxFileName,
											lineNumber: 123
										}
									}),
								...
								__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(
									"span",
									{
										className: "pill",
										onClick: function onClick() {
											_this2.props.dispatch(__WEBPACK_IMPORTED_MODULE_10__data_actions__["c" /* area_item_edit */](__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()(item, { _status: "intrigued" }), _this2.props.area_key));
										},
										__source: {
											fileName: _jsxFileName,
											lineNumber: 125
								...
								__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(
									"span",
									{
										className: "pill",
										onClick: function onClick() {
											_this2.props.dispatch(__WEBPACK_IMPORTED_MODULE_10__data_actions__["c" /* area_item_edit */](__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()(item, { _status: "ignored" }), _this2.props.area_key));
										},
										__source: {
											fileName: _jsxFileName,
											lineNumber: 133
									...
									__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement("span", { className: "icon-delete", __source: {
											fileName: _jsxFileName,
											lineNumber: 139
										}
									}),
			...
			return __WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(
				__WEBPACK_IMPORTED_MODULE_7__styled_Results_js__["a" /* Results */],
				...
				__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_12__Links__["a" /* default */], { area_key: this.props.area_key, __source: {
							fileName: _jsxFileName,
							lineNumber: 151
						}
					}),
					__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11__Query__["a" /* default */], { area_key: this.props.area_key, expanded: this.state.searchQueryExpanded, placeholder: (this.props.area.filters.length ? "Filter" : "Search") + " " + rated_items.length + " " + (this.props.area.filters.length ? "results" : "jobs") + "...", __source: {
							fileName: _jsxFileName,
							lineNumber: 152
						}
					}),
					__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13__Filters__["a" /* default */], { area_key: this.props.area_key, __source: {
							fileName: _jsxFileName,
							lineNumber: 153
						}
					}),
...
var ConnectedResults = Object(__WEBPACK_IMPORTED_MODULE_9_react_redux__["connect"])(mapStateToProps)(Object(__WEBPACK_IMPORTED_MODULE_8_react_router__["withRouter"])(Results));
...
//# sourceMappingURL=0.6ee37b815dda9fc8d2d0.hot-update.js.map