...
var mapStateToProps = function mapStateToProps(state, ownProps) {
	return {
		items: [].concat(state.my_items[ownProps.area_key].items, state.new_items[ownProps.area_key].items),
		filters: [].concat(state.my_items[ownProps.area_key].filters, state.new_items[ownProps.area_key].filters)
	};
};
...
//# sourceMappingURL=0.a33e446eb988ca85d482.hot-update.js.map