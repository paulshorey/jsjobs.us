...
var Search = function (_Component) {
  ...
  */
   ...
   */
			console.log("make and cache API requests for all {area_key}s except " + this.props.area_key);
			caches.open("api").then(function (cache) {
				return cache.addAll(["https://d3rinrx0dlc7zz.cloudfront.net/api/v1/jobs" + this.props.area_key + ".json"]);
			});
		}
	}, {
		key: "render",
...
//# sourceMappingURL=0.81aede437695c7484a8b.hot-update.js.map