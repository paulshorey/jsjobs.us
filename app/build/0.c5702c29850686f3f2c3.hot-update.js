				...
				return __WEBPACK_IMPORTED_MODULE_1_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
					while (1) {
						switch (_context.prev = _context.next) {
							case 0:
								_context.next = 2;
								return fetch(Object(__WEBPACK_IMPORTED_MODULE_11__modules_getAPI__["a" /* getAPIHostname */])() + ("/api/v1/jobs?text=" + match.params.search + "&start=" + query.start + "&limit=" + query.limit));
					...
					while (1) {
						switch (_context2.prev = _context2.next) {
							case 0:
								queryAdvance();
								_context2.next = 3;
								return fetch(Object(__WEBPACK_IMPORTED_MODULE_11__modules_getAPI__["a" /* getAPIHostname */])() + ("/api/v1/jobs?text=&start=" + query.start + "&limit=" + query.limit));
...
//# sourceMappingURL=0.c5702c29850686f3f2c3.hot-update.js.map