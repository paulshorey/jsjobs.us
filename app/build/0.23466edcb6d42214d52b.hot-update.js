...
var Query = function (_React$Component) {
	...
	function Query(props) {
		...
		_this.inputMultiplierChange = function (multiplier) {
			...
			// only act "onBlur"
			if (_this.refs.query_select.classList.contains("opened") && _this.refs.qInput.value) {
				_this.inputValueSubmit(multiplier); // pass multiplier, because setState is Async, and doesnt change fast enough
			}
			// DOM element:
			_this.refs.query_select.classList.toggle("opened");
		};
...
//# sourceMappingURL=0.23466edcb6d42214d52b.hot-update.js.map