...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__styled_Page_js__ = __webpack_require__("./src/routes/styled/Page.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_Layout_js__ = __webpack_require__("./src/components/Layout.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_search_Results__ = __webpack_require__("./src/components/search/Results.js");
 ...
 */
	function Search() {
		...
		var _this = __WEBPACK_IMPORTED_MODULE_6_babel_runtime_helpers_possibleConstructorReturn___default()(this, (Search.__proto__ || __WEBPACK_IMPORTED_MODULE_3_babel_runtime_core_js_object_get_prototype_of___default()(Search)).call(this));
        ...
        */
							...
							case 9:
								...
								data.forEach(function (item, i) {
									if (item.company.indexOf("ReqRes, LLC") !== -1 && item.text.indexOf("asic understanding of front-end technologies, such as JavaScript, HTML5, and CSS3") !== -1) {
										console.log("C - " + item.name + " - " + item.text.substring(0, 40) + " " + i);
									}
								});
							...
							case 22:
								...
								json.data.forEach(function (item, i) {
									if (item.company.indexOf("ReqRes, LLC") !== -1 && item.text.indexOf("asic understanding of front-end technologies, such as JavaScript, HTML5, and CSS3") !== -1) {
										console.log("D - " + item.name + " - " + item.text.substring(0, 40) + " " + i);
									}
								});
   ...
   */
			...
			return __WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(
				__WEBPACK_IMPORTED_MODULE_10__styled_Page_js__["a" /* Page */],
				{ className: "Page " + (this.state.isLoading ? " isLoading" : ""), __source: {
						fileName: _jsxFileName,
						lineNumber: 82
					}
				},
				__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_12__components_search_Results__["a" /* default */], { area_key: this.props.area_key || "us", items: items || [], className: this.state.isLoading ? " isLoading" : "", __source: {
						fileName: _jsxFileName,
						lineNumber: 83
					}
				})
...
var LaidOut = function (_Component2) {
	__WEBPACK_IMPORTED_MODULE_7_babel_runtime_helpers_inherits___default()(LaidOut, _Component2);

	function LaidOut() {
		__WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_classCallCheck___default()(this, LaidOut);

		return __WEBPACK_IMPORTED_MODULE_6_babel_runtime_helpers_possibleConstructorReturn___default()(this, (LaidOut.__proto__ || __WEBPACK_IMPORTED_MODULE_3_babel_runtime_core_js_object_get_prototype_of___default()(LaidOut)).apply(this, arguments));
	}

	__WEBPACK_IMPORTED_MODULE_5_babel_runtime_helpers_createClass___default()(LaidOut, [{
		key: "render",
		value: function render() {
			return __WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(
				__WEBPACK_IMPORTED_MODULE_11__components_Layout_js__["a" /* default */],
				{
					__source: {
						fileName: _jsxFileName,
						lineNumber: 131
				...
				__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(Search, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, this.props, {
					__source: {
						fileName: _jsxFileName,
						lineNumber: 132
					}
		...
		key: "getInitialProps",
		value: function () {
			var _ref3 = __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_asyncToGenerator___default()( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_1_babel_runtime_regenerator___default.a.mark(function _callee2(_ref2) {
				var match = _ref2.match;

				var props, res, data, _res2, json;
        ...
        */
							...
							case 7:
								...
								data.forEach(function (item, i) {
									if (item.company.indexOf("ReqRes, LLC") !== -1 && item.text.indexOf("asic understanding of front-end technologies, such as JavaScript, HTML5, and CSS3") !== -1) {
										console.log("A - " + item.name + " - " + item.text.substring(0, 40) + " " + i);
									}
								});
							...
							case 21:
								...
								json.data.forEach(function (item, i) {
									if (item.company.indexOf("ReqRes, LLC") !== -1 && item.text.indexOf("asic understanding of front-end technologies, such as JavaScript, HTML5, and CSS3") !== -1) {
										console.log("B - " + item.name + " - " + item.text.substring(0, 40) + " " + i);
									}
								});
								return _context2.abrupt("return", props);
...
/* harmony default export */ __webpack_exports__["default"] = (LaidOut);

/***/ })

};
//# sourceMappingURL=0.07df606f294f66a1de00.hot-update.js.map