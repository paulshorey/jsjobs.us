...
var Results = function (_Component) {
  ...
  */
		value: function render() {
			...
			// console.log("this.props.area.items", this.props.area.items);
...
var mapStateToProps = function mapStateToProps(data, ownProps) {
	...
	// console.log("ownProps.items", ownProps.items);
	// console.log("data_area.items", data_area.items);
	var newProps = {
		area: {
			items: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()(ownProps.items, data_area.items),
...
//# sourceMappingURL=0.547e00c10a86a6ce459b.hot-update.js.map