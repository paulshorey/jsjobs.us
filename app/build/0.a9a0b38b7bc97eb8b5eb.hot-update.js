...
/*
	lib
*/
var rate_items__object_to_array = function rate_items__object_to_array(items_object, filters_array) {
	/*
...
var Results = function (_Component) {
  ...
  */
		...
		value: function render() {
			...
			// var items_array = this.rate_items__object_to_array(this.props.items);
...
var mapStateToProps = function mapStateToProps(data, ownProps) {
	...
	console.log("process ownProps.items", __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_keys___default()(ownProps.items).length);
	var items = rate_items__object_to_array(ownProps.items, filters);
	var newProps = {
		items: items,
...
//# sourceMappingURL=0.a9a0b38b7bc97eb8b5eb.hot-update.js.map