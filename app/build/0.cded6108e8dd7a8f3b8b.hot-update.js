...
/*
	lib
*/
var rate_items_object_to_array = function rate_items_object_to_array(items_object, filters_array) {
	/*
...
var Results = function (_Component) {
  ...
  */
		...
		value: function render() {
			...
			// var items_array = this.rate_items_object_to_array(this.props.items);
...
var mapStateToProps = function mapStateToProps(data, ownProps) {
	...
	var items = rate_items_object_to_array(ownProps.items, filters);
	var newProps = {
		items: items,
...
//# sourceMappingURL=0.cded6108e8dd7a8f3b8b.hot-update.js.map