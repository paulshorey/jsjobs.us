		...
		value: function render() {
			...
			if (jobs) {
				...
				while (i < 100) {
					...
					// job.etc
					var locArr = job.location.split(",");
					job.location = locArr.reduce(function (a, b) {
						if (a.trim().length > 3 && a.length > b.length && !/[0-9]+/.test(a)) {
							return a;
						} else {
							return b;
						}
...
//# sourceMappingURL=0.30e279497efb8cb22cce.hot-update.js.map