...
var _this = this,
    _jsxFileName = "/www/jsjobs/app/src/components/search/Results__new.js";
...
/*
	lib
*/
var sort_items_object_to_array = function sort_items_object_to_array(items_object) {
	/*
...
var Results = function (_Component) {
	...
	function Results() {
		...
		return _ret = (_temp = (_this2 = __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_possibleConstructorReturn___default()(this, (_ref = Results.__proto__ || __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_get_prototype_of___default()(Results)).call.apply(_ref, [this].concat(args))), _this2), _this2.state = {}, _temp), __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_possibleConstructorReturn___default()(_this2, _ret);
	}
			...
			if (items_array) {
				...
				var _loop = function _loop() {
					...
					Items.push(__WEBPACK_IMPORTED_MODULE_7_react___default.a.createElement(
						"div",
						{ key: item._id + i, className: "item" + (item._status !== _this3.props.items_status ? " hidden" : " "), __source: {
								fileName: _jsxFileName,
								lineNumber: 112
							}
						},
							...
							__WEBPACK_IMPORTED_MODULE_7_react___default.a.createElement(
								...
								__WEBPACK_IMPORTED_MODULE_7_react___default.a.createElement(
									"span",
									{
										...
										onClick: function onClick() {
											...
											_this3.props.dispatch(__WEBPACK_IMPORTED_MODULE_11__data_actions__["d" /* my_item_save */](__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()(item, { _status: "applied" }), _this3.props.area_key));
										},
										__source: {
											fileName: _jsxFileName,
											lineNumber: 135
								...
								__WEBPACK_IMPORTED_MODULE_7_react___default.a.createElement(
									"span",
									{
										...
										onClick: function onClick() {
											// NOT immutable: immediately assigns to existing, rendered item - handle all immutability in Redux actions
											_this3.props.dispatch(__WEBPACK_IMPORTED_MODULE_11__data_actions__["d" /* my_item_save */](__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()(item, { _status: "intrigued" }), _this3.props.area_key));
										},
										__source: {
											fileName: _jsxFileName,
											lineNumber: 144
								...
								__WEBPACK_IMPORTED_MODULE_7_react___default.a.createElement(
									"span",
									{
										...
										onClick: function onClick() {
											// NOT immutable: immediately assigns to existing, rendered item - handle all immutability in Redux actions
											_this3.props.dispatch(__WEBPACK_IMPORTED_MODULE_11__data_actions__["d" /* my_item_save */](__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()(item, { _status: "ignored" }), _this3.props.area_key));
										},
										__source: {
											fileName: _jsxFileName,
											lineNumber: 153
							...
							__WEBPACK_IMPORTED_MODULE_7_react___default.a.createElement(
								"span",
								{
									onClick: function onClick(e) {
										_this3.refs.moreOptions.classList.toggle("active");
										_this3.setState({ searchQueryExpanded: !_this3.state.searchQueryExpanded });
									},
									__source: {
										fileName: _jsxFileName,
										lineNumber: 183
...
var mapStateToProps = function mapStateToProps(data, ownProps) {
	...
	var items = sort_items_object_to_array(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()({}, ownProps.items));
	var newProps = {
		items: items,
...
//# sourceMappingURL=0.7a9ca251352142f37a4f.hot-update.js.map