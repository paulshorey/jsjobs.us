							...
							__WEBPACK_IMPORTED_MODULE_7_react___default.a.createElement(
								...
								__WEBPACK_IMPORTED_MODULE_7_react___default.a.createElement(
									"span",
									{
										...
										onClick: function onClick() {
											...
											_this2.props.dispatch(__WEBPACK_IMPORTED_MODULE_11__data_actions__["c" /* area_item_add */](__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()({}, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()({ status: "applied" }, item)), _this2.props.area_key));
										},
										__source: {
											fileName: _jsxFileName,
											lineNumber: 114
								...
								__WEBPACK_IMPORTED_MODULE_7_react___default.a.createElement(
									"span",
									{
										className: "pill",
										onClick: function onClick() {
											_this2.props.dispatch(__WEBPACK_IMPORTED_MODULE_11__data_actions__["c" /* area_item_add */](__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()(item, { status: "intrigued" }), _this2.props.area_key));
										},
										__source: {
											fileName: _jsxFileName,
											lineNumber: 123
								...
								__WEBPACK_IMPORTED_MODULE_7_react___default.a.createElement(
									"span",
									{
										className: "pill",
										onClick: function onClick() {
											_this2.props.dispatch(__WEBPACK_IMPORTED_MODULE_11__data_actions__["c" /* area_item_add */](__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()(item, { status: "ignored" }), _this2.props.area_key));
										},
										__source: {
											fileName: _jsxFileName,
											lineNumber: 131
...
var mapStateToProps = function mapStateToProps(data, ownProps) {
	var areaItems = data.areas[ownProps.area_key].items.length ? data.areas[ownProps.area_key].items : [];
	var areaItems_ids = [];
	console.log("mapStateToProps areaItems", areaItems);
	areaItems.map(function (item) {
		return areaItems_ids.push(item._id); // make new array with only _id values
	});
	console.log("mapStateToProps areaItems_ids", areaItems_ids);
	var newItems = ownProps.items.filter(function (item) {
		return areaItems_ids.indexOf(item._id) === -1; // filter out items which were saved to redux
	});
...
//# sourceMappingURL=0.c4fcdeef08a3e415e62d.hot-update.js.map