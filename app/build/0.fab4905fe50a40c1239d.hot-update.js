...
var mapStateToProps = function mapStateToProps(redux, ownProps) {
	var myItems = redux.my_areas[ownProps.area_key].items.length ? redux.my_areas[ownProps.area_key].items : [];
	return {
		items: myItems.concat(ownProps.items),
		filters: []
	};
};
...
//# sourceMappingURL=0.fab4905fe50a40c1239d.hot-update.js.map