		...
		value: function render() {
			...
			var _loop = function _loop(key) {
				...
				Links.push(__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(
					...
					{
						className: "option " + (_this2.props.area_key === area.route ? " selected" : ""),
						to: area.route,
						key: area.route,
						onClick: function onClick(e) {
							if (area.route === _this2.props.area_key) {
								e.preventDefault();
							}
						},
						__source: {
...
//# sourceMappingURL=0.967fb629077fde6bafaf.hot-update.js.map