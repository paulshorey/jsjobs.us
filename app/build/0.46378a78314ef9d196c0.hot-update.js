...
/*
	lib
*/
var sort_items_object_to_array = function sort_items_object_to_array(items_object, filters_array, props_item_status) {
	/*
 ...
 */
	...
	for (var i in items_object) {
		...
		// except
		if (item._status === props_item_status) {
...
var mapStateToProps = function mapStateToProps(data, ownProps) {
	...
	var items = sort_items_object_to_array(ownProps.items, filters, "new");
	var newProps = {
		items: items,
...
//# sourceMappingURL=0.46378a78314ef9d196c0.hot-update.js.map