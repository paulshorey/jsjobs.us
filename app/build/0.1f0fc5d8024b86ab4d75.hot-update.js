...
var mapStateToProps = function mapStateToProps(data, ownProps) {
	...
	var whatFilters = data.what_areas[ownProps.area_key].filters.length ? data.what_areas[ownProps.area_key].filters : [];
	return {
		items: myItems.concat(ownProps.items), // lets not send 1000s of initial results through Redux, but pass directly from fetch in page to props items={items}
		filters: myFilters.concat(whatFilters)
	};
};
...
//# sourceMappingURL=0.1f0fc5d8024b86ab4d75.hot-update.js.map